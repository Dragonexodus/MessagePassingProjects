...
Für die Untersuchungen des Laufzeitverhaltens werden im folgenden feste $n$ mit variierenden $p$ und feste $p$ mit variierende $n$ betrachtet. Für die Einflussfaktoren liegen die Obergrenzen bei $n=45000$ und $p=88$. Im folgenden werden dennoch Messungen bis maximal $n=40000$ und $p=44$ betrachtet, da Laufzeitverhalten, Speed-Up und Effizienz  für diese Größen ersichtlich sind und andere Benutzer das Cluster parallel nutzen.

\autoref{ref:p1}
\autoref{ref:p44}

% Auswertungsoverhead durch Master (Auswertung von Gather - parallel)
Wie man aus dem gegebenen Laufzeitmessungen entnehmen kann, liefern alle betrachteten Fälle: \texttt{Mismatch}, \texttt{FoundOne} und \texttt{Nothing} wesentlich kürzere Laufzeiten für den sequentiellen Fall, als für den parallelen. Dies ist damit begründet, dass kein Kommunikationsoverhead für die Auswertung existiert, da der \texttt{Master} direkt seine Suche abbrechen kann, während im parallele Programm der \texttt{Master} auf alle Teilergebnisse warten muss.
