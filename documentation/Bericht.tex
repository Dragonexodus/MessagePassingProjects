...
Werden diese Muster nicht erkannt, aber schwarze Pixel erkannt, dann existiert ein Rechteck. Andernfalls werden nicht zuzuordnende schwarze Pixel (\texttt{Mismatch}) oder gar keine schwarzen Pixel (\texttt{Nothing}) im Bild gefunden.
...
\begin{enumerate}
	...
	\item Gibt es nur ein Rechteck (\texttt{FoundOne}) und sonst \texttt{Nothing}, kann das Rechteck ausgegeben werden.
\end{enumerate}
