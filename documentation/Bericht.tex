...
\lstset{language=Fortran,frame=none, keepspaces=false, basicstyle=\scriptsize,showstringspaces=false}  
...
\begin{itemize}
	\item run -f0 4 2 A2star.px \textbf{FUNCTION} \textbf{N}
\end{itemize}
...
Ein weiteres Problem besteht, wenn aufgrund der Prozessoranzahl eine periodische Verteilung entsteht, dann sinkt die Genauigkeit für das angenäherte Pi wie in \autoref{ref:piN} in Zeile 2 zu sehen ist ($\frac{32768}{6} = 5461.3\bar{3}$).
