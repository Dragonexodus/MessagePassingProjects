...
Ein Grund dafür das Testfunktion 1 schlechtere Ergebnisse als Funktion 2 liefert, hängt damit zusammen, dass für die Funktion 1 die Integralgrenze ($b$) PI selbst ist. Somit treten größere Ungenauigkeiten als bei Funktion 2 ($b=1$) auf, da PI eine irrationale Zahl ist. Zum anderen muss für die Testfunktion 1 nur bis $1$ integriert werden, deshalb terminiert die Integration für diese Funktion wesentlich früher.
