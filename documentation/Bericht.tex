...
\lstset{language=Fortran,frame=none, keepspaces=false,tabsize=1,captionpos=b, basicstyle=\scriptsize,showstringspaces=false}  
...
Ein Grund dafür das die Funktion 1 schlechte Näherungswerte liefert liegt unter Anderem an der Oberegrenze.
