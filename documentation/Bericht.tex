...
Im Wesentlichen wird ein Rechteck durch das Finden eines schwarzen Pixels \linebreak(schwarz=0, weiß=1) und das Überprüfen von ausschließenden Mustern. 
...
\end{minipage}
\end{figure}
Wie man aus dem gegebenen Laufzeitmessungen (\autoref{ref:p44} und \autoref{ref:p1}) für feste $p$ entnehmen kann, verschlechtert sich die Laufzeit beider Messungen quadratisch, dies ist mit dem Aufwand der Überprüfung des quadratischen Bildes zu begründen.
